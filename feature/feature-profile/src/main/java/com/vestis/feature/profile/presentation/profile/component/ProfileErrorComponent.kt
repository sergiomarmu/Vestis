...
fun ProfileErrorComponent(
    ...
    Column(
        ...
        Icon(
            ...
            contentDescription = stringResource(id = R.string.profile_error_state_icon_description),
        ...
        Button(
            ...
            Text(text = stringResource(id = R.string.profile_retry_button))
        }
    }
}
...
@Preview
@Composable
private fun ProfileErrorComponentPreview() {
